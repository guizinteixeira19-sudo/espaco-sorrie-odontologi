  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: 'url(https://precisionlaboratorio.com.br/storage/img-post-blog/capa-post-estetica-do-sorriso-para-eventos-especiais-planejamento-estrategico-para-um-sorriso-perfeito.webp)',
        }}
      />
